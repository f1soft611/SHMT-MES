...
`품목_관리_UI_가이드.md` 와 `품목_관리_요약.md` 병합 대표 문서.

| 날짜    | 변경                 | 내용                                  | 출처      |
| ------- | -------------------- | ------------------------------------- | --------- |
| 2025-10 | 초기 구현            | CRUD + 검색(코드/명/규격) + 타입 필터 | 요약      |
| 2025-11 | 인터페이스 항목 구분 | INTERFACE_YN=Y 읽기전용 처리          | UI 가이드 |
| 2025-11 | 통합 문서화          | 요약 아카이브, 본 문서 대표화         | 통합 작업 |
