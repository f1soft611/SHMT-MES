...
> ⚠️ **중요**: 처음 프로젝트를 설정하는 경우 [로컬 개발 환경 설정 가이드](./문서/로컬_개발_환경_설정.md)를 먼저 확인하세요!
>
> 🔒 **보안**: 이 프로젝트는 민감한 정보 보호를 위한 보안 정책이 적용되어 있습니다. [SECURITY.md](./SECURITY.md)를 반드시 읽어주세요.

## 📚 프로젝트 문서

프로젝트 개발을 시작하기 전에 다음 문서들을 참고하세요:

- **[🔒 보안 정책](./SECURITY.md)** - **필독!** 민감한 정보 관리 가이드
- **[🔧 로컬 개발 환경 설정](./문서/로컬_개발_환경_설정.md)** - **필독!** 첫 시작 가이드
- **[📖 문서 인덱스](./문서/README.md)** - 모든 문서의 시작점
- **[🔵 백엔드 개발 가이드](./문서/백엔드_개발_가이드.md)** - Spring Boot 백엔드 개발
- **[🟢 프론트엔드 개발 가이드](./문서/프론트엔드_개발_가이드.md)** - React 프론트엔드 개발
