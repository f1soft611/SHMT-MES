# SHMT-MES Copilot Customizations
...
4. 신규 화면/기능이면 백엔드 개발자와 프론트 개발자가 필요한 파일을 생성해 작업
5. 결과 문서(`문서/검증/`) 저장 확인

## 6-Step Agents

1. `.github/agents/project-leader.agent.md` (`프로젝트 리더`)
2. `.github/agents/backend-developer.agent.md` (`백엔드 개발자`)
...
- `.github/skills/multi-db-sql-review/SKILL.md`
