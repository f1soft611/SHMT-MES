...
-- 정부 로그인 이력 인터페이스 컬럼 추가
IF COL_LENGTH('MES_LOGIN_HISTORY', 'GOV_INTERFACE_YN') IS NULL
BEGIN
    ALTER TABLE MES_LOGIN_HISTORY ADD GOV_INTERFACE_YN NCHAR(1) NOT NULL DEFAULT 'N';
END
GO

IF COL_LENGTH('MES_LOGIN_HISTORY', 'GOV_INTERFACE_DT') IS NULL
BEGIN
    ALTER TABLE MES_LOGIN_HISTORY ADD GOV_INTERFACE_DT DATETIME2 NULL;
END
GO

IF COL_LENGTH('MES_LOGIN_HISTORY', 'GOV_RECPTN_RSLT_CD') IS NULL
BEGIN
    ALTER TABLE MES_LOGIN_HISTORY ADD GOV_RECPTN_RSLT_CD NVARCHAR(20) NULL;
END
GO

IF COL_LENGTH('MES_LOGIN_HISTORY', 'GOV_RECPTN_RSLT') IS NULL
BEGIN
    ALTER TABLE MES_LOGIN_HISTORY ADD GOV_RECPTN_RSLT NVARCHAR(200) NULL;
END
GO

IF COL_LENGTH('MES_LOGIN_HISTORY', 'GOV_RECPTN_RSLT_DTL') IS NULL
BEGIN
    ALTER TABLE MES_LOGIN_HISTORY ADD GOV_RECPTN_RSLT_DTL NVARCHAR(4000) NULL;
END
GO

IF COL_LENGTH('MES_LOGIN_HISTORY', 'GOV_FAIL_REASON') IS NULL
BEGIN
    ALTER TABLE MES_LOGIN_HISTORY ADD GOV_FAIL_REASON NVARCHAR(1000) NULL;
END
GO

IF COL_LENGTH('MES_LOGIN_HISTORY', 'GOV_REQUEST_JSON') IS NULL
BEGIN
    ALTER TABLE MES_LOGIN_HISTORY ADD GOV_REQUEST_JSON NVARCHAR(MAX) NULL;
END
GO

IF COL_LENGTH('MES_LOGIN_HISTORY', 'GOV_RESPONSE_JSON') IS NULL
BEGIN
    ALTER TABLE MES_LOGIN_HISTORY ADD GOV_RESPONSE_JSON NVARCHAR(MAX) NULL;
END
GO
