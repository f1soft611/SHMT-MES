...
DECLARE @QC_CODE        NVARCHAR(50)  = 'DF001';     -- 불량코드 (MES_CCMMNDETAIL_CODE.CODE where CODE_ID='DEFECT_CODE')
-- 실제 DB에 있는 불량코드 확인 쿼리:
-- SELECT CODE, CODE_NM FROM MES_CCMMNDETAIL_CODE WHERE CODE_ID = 'DEFECT_CODE' AND USE_AT = 'Y';
